...
import { getSelfMediaProofsQueryHandler } from './controllers/media_proofs/get_self_media_proofs';
import { getMediaProofsByAuthorQueryHandler } from './controllers/media_proofs/get_user_media_proofs';
...
export const appRouter = router({
  media_proof: router({
    ...
    byAuthorId: getMediaProofsByAuthorQueryHandler,
    self: getSelfMediaProofsQueryHandler,
